            ...
            @auth
                ...
                <div class="nk-header-tools">
                    <ul class="nk-quick-nav ms-2">
                        <li>
                            <button class="btn btn-icon btn-md btn-zoom d-sm-inline-flex" data-bs-toggle="offcanvas"
                                ...
                                <div class="dropdown-content dropdown-content-x-lg py-3 border-bottom border-light">
                                    <div class="media-group">
                                        ...
                                        <div class="media-text">
                                            ...
                                            <span
                                                class="sub-text">{{ auth()->user()->role_id == 1 ? 'Admin' : 'Nhân viên' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="dropdown-content dropdown-content-x-lg py-3 border-bottom border-light">
...
<div class="offcanvas offcanvas-end offcanvas-size-lg" id="notify">
    <div class="offcanvas-header border-bottom border-light">
        <h5 class="offcanvas-title" id="offcanvasTopLabel">Thông tin mới</h5><button type="button" class="btn-close"
